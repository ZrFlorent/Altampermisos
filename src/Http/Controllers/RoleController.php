...
namespace ZrFlorent\Altamrolespermisosdevel\Http\Controllers;
...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Altamrp::role.index', compact('roles'));
    }
    ...
    public function create()
    {
        ...
        return view('Altamrp::role.create', compact('permissions'));
    }
...
*/                 $role ->permissions()->sync($request->get('permission'));
    ...
    public function show(Role $role)
    {
       $this->authorize('haveaccess','role.show');
        ...
        $array_permission_role=[];
        
        foreach($role->permissions as $permission){
            $array_permission_role[]=$permission->id;
        }
        

        $permissions = Permission::get();
        return view('Altamrp::role.show', compact('permissions', 'role', 'array_permission_role'));
    }
    ...
    public function edit(Role $role)
    {
       $this-> authorize('haveaccess','role.edit');
        ...
        $permissions = Permission::get();
        return view('Altamrp::role.edit', compact('permissions', 'role', 'array_permission_role'));
    }
